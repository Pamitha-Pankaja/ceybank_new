...
//    }
    ...
    public void approveItems(ApproveStoreRequisitionItemListRequest request) {
        for (ApproveStoreRequisitionItemListRequest.ItemApproval approval : request.getItems()) {
